<?php
/**
 * [pmprommpu_setup_and_upgrade These functions are run on startup if user is an admin. They check for upgrades - and if it's a new install, everything is an upgrade!
 *
