 ...
 * Plugin URI: https://www.paidmembershipspro.com/pmpro-multiple-memberships-per-user/
 ...
 * Author URI: https://www.square-lines.com
 */
...
define( 'PMPROMMPU_VER', '.4.1' ); // Version string to signal cache refresh during JS/CSS updates
...
add_action( 'wp_enqueue_scripts', 'pmprommpu_init' );
add_action( 'admin_enqueue_scripts', 'pmprommpu_init' );
